...
const Sidebar = ({ category, setCategory }: IProps) => {
  ...
  //ClassNames
  const activeLink =
    "xl:bg-red-600 hover:bg-red-600 flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-start cursor-pointer font-semibold text-white rounded";

  const normalLink =
    "hover:bg-red-600 xl:border-gray-600 flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-start cursor-pointer font-semibold rounded text-white";
